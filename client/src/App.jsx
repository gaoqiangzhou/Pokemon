...
function App() {
  const {pokemons, selectPksUpdate} = usePokemonInfo()
  return (
              ...
              <div className="flex flex-col h-screen justify-center items-center">{/*flex wrapper*/}
                ...
                <div className="flex flex-row h-[75%] w-[90%]">
                  <Containter className = "w-1/3 flex flex-col gap-y-2">
                    ...
                    <SearchBar/>
                    <PokemonCardList pks = {[...pokemons]} handle = {selectPksUpdate} className="h-[80%]"/>
                  </Containter>
                  <div className = "w-1/3 flex flex-col gap-y-2">
                    <Containter className = "w-full h-[80%]">
                      <h1 className="text-center font-bold h-[5%]">Selection</h1>
                    </Containter>
                    <PokeButton className = "w-1/2"/>
                  </div>
                  <Containter className = "w-1/3 flex flex-col gap-y-2"><h1 className="text-center font-bold h-[5%]">Result</h1></Containter>
                </div>
              </div>
            </div>
  )
